...
public class ApiError {
    ...
    public static final String MESSAGE_DELETE_NOT_SUPPORTED = "Request method 'DELETE' not supported";
    ...
    public static final String MESSAGE_MEDIA_TYPE_NOT_ACCEPTABLE = "Acceptable MIME type: "
    ...
    public static final String MESSAGE_OPTIONS_NOT_SUPPORTED = "Request method 'OPTIONS' not supported";
    ...
    public static final String MESSAGE_UNSUPPORTED_MEDIA_TYPE = "Content type must be "
            + MediaType.APPLICATION_JSON_VALUE;
